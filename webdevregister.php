...
<!-- End Google Tag Manager (noscript) -->
	<div class="page-content">
		<div class="form-v4-content">
			<div class="form-left">
				<h2>WEB DEV - MAKING YOUR OWN WEBSITE</h2>
        <p class="text-2" style="font-size:18px;"> 1) Main focus of the web dev mentorship program is  HTML and CSS languages.</p>
        <p class="text-2" style="font-size:18px;"> 2) While teaching these languages, tasks will be given on how to run the code </p>
        <p class="text-2" style="font-size:18px;"> 3) After successful completion of learning about the languages, students will be taught and shown how to create a basic portfolio website. </p>
        <p class="text-2" style="font-size:18px;"> 4) All doubts regarding these activities will be cleared by the mentor </p>
        <p class="text-2" style="font-size:18px;"> 5) TADA! you can make a fully functional basic website ON YOUR OWN</p>
	    ...
	    {
	      $count=0;
	      $res = mysqli_query($link,"select * from webdev where username='$_POST[username]'") or die(mysqli_error($link));
	      ...
	      if($count>0)
	      {
	        ...
	        mysqli_query($link,"insert into webdev values(NULL,'$_POST[first_name]','$_POST[last_name]','$_POST[username]','$_POST[password]','$_POST[email]','$_POST[contact]','$_POST[school]','$_POST[class]','$_POST[refer]')") or die(mysqli_error($link));
	        ?>
	        <script type="text/javascript">
	          document.getElementById("success").style.display="none";
